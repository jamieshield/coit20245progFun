...
jsplotlib.plot = function(chart, rows = null, cols = null, index = null) {
  ...
  */
  ...
  that.erase_charts = function() {
    $("#" + chart.attr("id")).empty();
    $(".chart").empty(); // hack for multiple matplotlibs per tab - jsut clear all
	// the problem is it looks for subplot0 without pplotchart context
  };
...
var $builtinmodule = function(name) {
  ...
  var bar_f = function(left, height, width, color, edgecolor, align, bottom, alpha, label) {
    ...
    let debugbarchart=false;
    if (debugbarchart) console.log("barchart");
    if (debugbarchart) console.log("label");
    if (debugbarchart) console.log(label);
    if (debugbarchart) console.log("left");
    if (debugbarchart) console.log(left);

    if (left.v == null || Sk.builtin.checkNone(left)) {
        throw new Sk.builtin.ValueError("missing 1 required positional argument: 'left'");
    }
    if (debugbarchart) console.log("heigth");
    if (debugbarchart) console.log(height);
    ...
    if (debugbarchart) console.log("color");
    if (debugbarchart) console.log(color);
    ...
    if (debugbarchart) console.log("edgecolor");
    if (debugbarchart) console.log(edgecolor);
    ...
    if (debugbarchart) console.log("alpha");
    if (debugbarchart) console.log(alpha);
    ...
    if (debugbarchart) console.log("align");
    if (debugbarchart) console.log(align);
    ...
    if (debugbarchart) console.log("bottom");
    if (debugbarchart) console.log(bottom);
    ...
    if (debugbarchart) console.log("post bottom");
    ...
    if (debugbarchart) console.log("post label");
    ...
    if (debugbarchart) console.log("width");
    if (debugbarchart) console.log(width);
